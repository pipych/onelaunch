...
VIAddVersionKey "ProductVersion" "0.4.2"
...
Section "OneLaunch" SecMain
  ...
  CreateShortCut "$SMPROGRAMS\OneLaunch\������� OneLaunch.lnk" "$INSTDIR\uninstall.exe"
